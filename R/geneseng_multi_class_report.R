#' Generate report for multi classification
#'
...
#' 
#' @export
geneseng_multi_class_report <- function(output_path, filename, timeout = 60, ...) {
  
  path <- "rmarkdown/templates/skeleton"
  
  chrome_print(
    render(
      input = system.file(file.path(path, "skeleton2.Rmd"), package = "genesengReport"),

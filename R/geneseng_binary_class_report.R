#' Generate report for binary classification
#'
...
#' 
#' @export
geneseng_binary_class_report <- function(output_path, filename, timeout = 60, ...) {
  
  path <- "rmarkdown/templates/skeleton"
  
  chrome_print(
    render(
      input = system.file(file.path(path, "skeleton.Rmd"), package = "genesengReport"),
